...
This project targets the intersection of **Deep learning, generative models, multimodal LLM agents** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Ruslan Salakhutdinov's research area.
...
Advisor-specific slice: **Deep learning, generative models, multimodal LLM agents**.
