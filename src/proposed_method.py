...
METHOD_SPEC = {
    "algorithm_id": "P001-Salakhutdinov-GenerativeModels",
    "algorithm_name": "SalakhutdinovGroundedGenerativeModelsGateLoop",
    ...
    "decision_rule": "Rank seed cases by language-specific priority score with Salakhutdinov-aligned focus term 'generative models'.",
